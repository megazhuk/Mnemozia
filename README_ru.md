...
- **Семантический поиск:** векторный поиск через multilingual-e5-small — находит по смыслу на русском и английском
...
- **Ленивая загрузка:** модель эмбеддингов загружается только при первом использовании — ноль ОЗУ до первого запроса
...
| `search` | Семантический векторный поиск (LanceDB 0.33: только semantic; keyword-режим запланирован) |
